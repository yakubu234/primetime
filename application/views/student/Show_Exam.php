       ...
       <!-- special css to make a rectanguar radio button  -->
            ...
            function secondPassed() {
                ...
                <button class="btn btn-primary waves-effect waves-light col-sm-2 text-center" style="margin: 0px auto;"> <b>Time Left : <span id="countdown"></span></b></button>                                
                 <div class="row col-sm-12">
                                <?php
                                echo '<form action="'.base_url('save_answer_selected?q=quiz&step=2&eid=' . $eid . '&n=' . $sn . '&t=' . $total).'" method="POST">';
                    ...
                    $subject = $value->subject;
                                ...
                                echo '<div class="col-sm-12" ><input type="hidden" value="'.$subject.'" name="subject" />
                                    ...
                                    <br/>
                                    <div class="boxed"><tr><td><span  style="font-size:18px;display:inline-block;">(A)</span></td><td>&nbsp;&nbsp;<input type="radio" id="'.$optAid.'" name="ans" value="'.$optAid.'" onclick="enable()"><label for="'.$optAid.'">'.$optionA.'</label></td></tr></div>
                                    ...
                                    echo '<button id="" class="previous btn btn-success" type="button">Previous</button>                    
        <button id="'.$Total_now.'" class="next btn btn-success" type="button" >Next</button></div></div>';
                                    ...
                                    ?>
                                        ...
                                        <p class="text-center" style="margin-top:10px;"><input type="submit" class="btn btn-info" disabled="true" id="sbutton" value="Next" > </p></form></div>
