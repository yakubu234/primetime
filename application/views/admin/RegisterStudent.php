      ...
      <!-- check student -->
        <div class="modal fade bs-example-modal-centerab-multi-upload" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title mt-0"> Upload Multiple Student Image</h5>

                                                        <div class="col-sm-4" style="float: right;" ><a><button class="mdi mdi-arrow-down-bold-hexagon-outline btn btn-primary waves-effect waves-light" > Max Picture Size 100MB</button></a></div>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                        </div>
                                                        <div class="modal-body">
                                                         <form action="<?php echo base_url('Upload_Student_Multiple_Picture') ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label>Choose Pictures</label>
                                            <input type="file" class="filestyle" data-buttonname="btn-secondary" name='files[]' multiple="">
                                        </div>
                                        
                                        <div class="form-group col-sm-12" >
                                            <div style="float:right;">
                                                <button type="submit" class="btn btn-primary waves-effect waves-light" name="fileSubmit">
                                                    Upload
                                                </button>
                                                <button type="reset" class="btn btn-secondary waves-effect m-l-5">
                                                    Cancel
