                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card m-b-20">
                                <div class="card-body">    
                                    <div class="col-sm-12 m-b-20"><div class="row" ><h4 class="mt-0 header-title col-sm-6">Admin details from Database</h4><span class="col-sm-6" ><button style="float:right;" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-centeraadmin_subject">Add New Subjects</button></span> </div></div>
                                <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <div class="card-body">
