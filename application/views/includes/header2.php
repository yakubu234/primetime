    ...
    <body>
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="components-session-timeout.html">Register Student</a></li>
                                </ul>
                            </li>
        ...
        <div class="modal fade bs-example-modal-centera" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title mt-0">Select Exam Name</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                        </div>
                                                        <div class="modal-body">
                                                         <form action="<?php echo base_url('Create_Question_Old') ?>" method="POST" >
        ...
        <!-- check student    data-toggle="modal" data-target=".bs-example-modal-centera"-->